...
class SkipganInferrer:
    def __init__(self):
        ...
        self.gen_path = '../saved_models/Generator_128_20_200'
        self.disc_path = '../saved_models/Discriminator128_20_200'
        self.generator = keras.models.load_model(f'../saved_models/Generator_128_20_200')
        self.discriminator = keras.models.load_model(f'../saved_models/Discriminator128_20_200')
